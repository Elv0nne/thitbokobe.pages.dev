export async function onRequestGet({ env, waitUntil }) {
    ...
    const originSvg = await fetch('https://lanyard.cnrad.dev/api/1363311902205415494?showDisplayName=true&bg=0d1117&idleMessage=https://thitbokobe-pages-dev.pages.dev/').then(r => r.text());
